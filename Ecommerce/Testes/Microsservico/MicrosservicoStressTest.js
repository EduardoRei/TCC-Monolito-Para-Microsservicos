...
export default function () {
    ...
    const getResponse = http.get('http://localhost:8000/produto/api/Produto', requestParams);
    ...
    const postResponse = http.post('http://localhost:8000/pedido/api/Pedido', postPayload, requestParams);
